...
public final class Native implements Version
{
    ...
    public static <T> T loadLibrary(final String name, final Class<T> interfaceClass, final Map<String, ?> options) {
        ...
        final Library.Handler handler = new Library.Handler(name, (Class)interfaceClass, (Map)options);
        final ClassLoader loader = interfaceClass.getClassLoader();
        final Object proxy = Proxy.newProxyInstance(loader, new Class[] { interfaceClass }, (InvocationHandler)handler);
    ...
    static Class<?> findEnclosingLibraryClass(Class<?> cls) {
        ...
        if (Callback.class.isAssignableFrom(cls)) {
            cls = (Class<?>)CallbackReference.findCallbackClass((Class)cls);
        }
        ...
        final InvocationHandler newHandler = new InvocationHandler() {
            ...
            public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
                synchronized (handler.getNativeLibrary()) {
                    return handler.invoke((Object)library, method, args);
                }
            }
        };
    ...
    private static int getConversion(Class<?> type, final TypeMapper mapper, final boolean allowObjects) {
        ...
        if (mapper != null) {
            ...
            if (fromNative != null) {
                final Class<?> nativeType = (Class<?>)fromNative.nativeType();
    ...
    private static NativeMapped fromNative(final Class<?> cls, final Object value) {
        return (NativeMapped)NativeMappedConverter.getInstance(cls).fromNative(value, new FromNativeContext((Class)cls));
    }
    
    private static NativeMapped fromNative(final Method m, final Object value) {
        final Class<?> cls = m.getReturnType();
        return (NativeMapped)NativeMappedConverter.getInstance(cls).fromNative(value, (FromNativeContext)new MethodResultContext((Class)cls, (Function)null, (Object[])null, m));
    }
    ...
    private static Object fromNative(final FromNativeConverter cvt, final Object o, final Method m) {
        return cvt.fromNative(o, (FromNativeContext)new MethodResultContext((Class)m.getReturnType(), (Function)null, (Object[])null, m));
    }
    ...
    public static void detach(final boolean detach) {
        ...
        if (detach) {
            ...
            final Pointer p = (Pointer)Native.nativeThreadTerminationFlag.get();
    ...
    static {
        ...
        DEFAULT_HANDLER = (Callback.UncaughtExceptionHandler)new Callback.UncaughtExceptionHandler() {
