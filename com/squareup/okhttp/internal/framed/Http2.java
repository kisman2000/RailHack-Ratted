...
public final class Http2 implements Variant
{
    ...
    public FrameReader newReader(final BufferedSource source, final boolean client) {
        return (FrameReader)new Reader(source, 4096, client);
    }
    
    @Override
    public FrameWriter newWriter(final BufferedSink sink, final boolean client) {
        return (FrameWriter)new Writer(sink, client);
    }
    ...
    static final class Reader implements FrameReader
    {
        ...
        Reader(final BufferedSource source, final int headerTableSize, final boolean client) {
            ...
            this.hpackReader = new Hpack.Reader(headerTableSize, (Source)this.continuation);
        }
        ...
        public boolean nextFrame(final FrameReader.Handler handler) throws IOException {
            try {
        ...
        private void readHeaders(final FrameReader.Handler handler, int length, final byte flags, final int streamId) throws IOException {
            if (streamId == 0) {
            ...
            handler.headers(false, endStream, streamId, -1, (List)headerBlock, HeadersMode.HTTP_20_HEADERS);
        }
        ...
        private void readData(final FrameReader.Handler handler, int length, final byte flags, final int streamId) throws IOException {
        ...
        private void readPriority(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (length != 5) {
        ...
        private void readPriority(final FrameReader.Handler handler, final int streamId) throws IOException {
        ...
        private void readRstStream(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (length != 4) {
        ...
        private void readSettings(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (streamId != 0) {
        ...
        private void readPushPromise(final FrameReader.Handler handler, int length, final byte flags, final int streamId) throws IOException {
            if (streamId == 0) {
            ...
            length = lengthWithoutPadding(length, flags, padding);
            final List<Header> headerBlock = this.readHeaderBlock(length, padding, flags, streamId);
            handler.pushPromise(streamId, promisedStreamId, (List)headerBlock);
        }
        
        private void readPing(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (length != 8) {
        ...
        private void readGoAway(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (length < 8) {
        ...
        private void readWindowUpdate(final FrameReader.Handler handler, final int length, final byte flags, final int streamId) throws IOException {
            if (length != 4) {
