...
public abstract class Enum implements Comparable, Serializable
{
    ...
    private void init(final String name) {
        ...
        if (Enum.class$org$apache$commons$lang$enums$Enum == null) {
            class$org$apache$commons$lang$enums$Enum = (Enum.class$org$apache$commons$lang$enums$Enum = (class$ = class$("org.apache.commons.lang.enums.Enum")));
        }
        else {
            class$ = (class$org$apache$commons$lang$enums$Enum = Enum.class$org$apache$commons$lang$enums$Enum);
        }
        final Class clazz = class$org$apache$commons$lang$enums$Enum;
        Entry entry;
        synchronized (class$) {
    ...
    public int compareTo(final Object other) {
        ...
        throw new ClassCastException("Different enum class '" + ClassUtils.getShortClassName((Class)other.getClass()) + "'");
    }
