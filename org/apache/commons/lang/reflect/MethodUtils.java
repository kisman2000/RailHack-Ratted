        ...
        try {
            ...
            for (int i = 0, size = methods.length; i < size; ++i) {
                if (methods[i].getName().equals(methodName) && ClassUtils.isAssignable(parameterTypes, (Class[])methods[i].getParameterTypes(), true)) {
                    ...
                    if (accessibleMethod != null && (bestMatch == null || MemberUtils.compareParameterTypes((Class[])accessibleMethod.getParameterTypes(), (Class[])bestMatch.getParameterTypes(), parameterTypes) < 0)) {
