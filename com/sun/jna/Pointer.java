...
public class Pointer
{
    ...
    Object getValue(final long offset, final Class<?> type, final Object currentValue) {
        ...
        if (Structure.class.isAssignableFrom(type)) {
            ...
            if (fp == null) {
                ...
                if (!fp.equals(oldfp)) {
                    cb = CallbackReference.getCallback((Class)type, fp);
                }
                result = cb;
            }
        }
            ...
            if (nm != null) {
                ...
                result = nm.fromNative(value, new FromNativeContext((Class)type));
                if (nm.equals(result)) {
                    result = nm;
                }
            }
                ...
                result = tc.fromNative(value2, new FromNativeContext((Class)type));
            }
        }
        else {
            if (!type.isArray()) {
    ...
    private void readArray(final long offset, final Object o, final Class<?> cls) {
        ...
        if (cls == Byte.TYPE) {
            ...
            final NativeMappedConverter tc = NativeMappedConverter.getInstance((Class)cls);
            final int size = Native.getNativeSize((Class)result.getClass(), result) / array.length;
            for (int j = 0; j < array.length; ++j) {
                final Object value = this.getValue(offset + size * j, tc.nativeType(), array[j]);
                array[j] = (NativeMapped)tc.fromNative(value, new FromNativeContext((Class)cls));
            }
        }
    }
    ...
    void setValue(final long offset, final Object value, final Class<?> type) {
        if (type == Boolean.TYPE || type == Boolean.class) {
            ...
            final NativeMappedConverter tc = NativeMappedConverter.getInstance((Class)type);
            final Class<?> nativeType = (Class<?>)tc.nativeType();
    ...
    private void writeArray(final long offset, final Object value, final Class<?> cls) {
        if (cls == Byte.TYPE) {
            ...
            final NativeMappedConverter tc = NativeMappedConverter.getInstance((Class)cls);
            final Class<?> nativeType = (Class<?>)tc.nativeType();
            final int size = Native.getNativeSize((Class)value.getClass(), value) / buf10.length;
            for (int k = 0; k < buf10.length; ++k) {
                final Object element = tc.toNative((Object)buf10[k], new ToNativeContext());
