...
public class StringUtils
{
    ...
    public static int indexOfAnyBut(final String str, final String searchChars) {
        ...
        for (int strLen = str.length(), i = 0; i < strLen; ++i) {
            final char ch = str.charAt(i);
            final boolean chFound = searchChars.indexOf(ch) >= 0;
    ...
    public static String join(final Object[] array, final char separator, final int startIndex, final int endIndex) {
        ...
        final StrBuilder buf = new StrBuilder(bufSize);
    ...
    public static String replace(final String text, final String searchString, final String replacement, int max) {
        ...
        final StrBuilder buf = new StrBuilder(text.length() + increase);
        while (end != -1) {
    ...
    public static String replaceChars(final String str, final String searchChars, String replaceChars) {
        ...
        final StrBuilder buf = new StrBuilder(strLength);
    ...
    public static String repeat(final String str, final int repeat) {
        ...
        switch (inputLength) {
            ...
            default: {
                final StrBuilder buf = new StrBuilder(outputLength);
    ...
    public static String swapCase(final String str) {
        ...
        final StrBuilder buffer = new StrBuilder(strLen);
        char ch = '\0';
        for (int i = 0; i < strLen; ++i) {
            ch = str.charAt(i);
    ...
    public static String abbreviateMiddle(final String str, final String middle, final int length) {
        ...
        final StrBuilder builder = new StrBuilder(length);
    ...
    public static String normalizeSpace(String str) {
        ...
        final StrBuilder b = new StrBuilder(str.length());
