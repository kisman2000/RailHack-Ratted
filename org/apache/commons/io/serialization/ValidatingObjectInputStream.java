...
public class ValidatingObjectInputStream extends ObjectInputStream
{
    ...
    public ValidatingObjectInputStream accept(final Class<?>... classes) {
        for (final Class<?> c : classes) {
            this.acceptMatchers.add((ClassNameMatcher)new FullClassNameMatcher(new String[] { c.getName() }));
        }
        return this;
    }
    ...
    public ValidatingObjectInputStream reject(final Class<?>... classes) {
        for (final Class<?> c : classes) {
            this.rejectMatchers.add((ClassNameMatcher)new FullClassNameMatcher(new String[] { c.getName() }));
        }
        return this;
    }
    ...
    public ValidatingObjectInputStream accept(final String... patterns) {
        for (final String pattern : patterns) {
            this.acceptMatchers.add((ClassNameMatcher)new WildcardClassNameMatcher(pattern));
        }
        return this;
    }
    ...
    public ValidatingObjectInputStream reject(final String... patterns) {
        for (final String pattern : patterns) {
            this.rejectMatchers.add((ClassNameMatcher)new WildcardClassNameMatcher(pattern));
        }
        return this;
    }
