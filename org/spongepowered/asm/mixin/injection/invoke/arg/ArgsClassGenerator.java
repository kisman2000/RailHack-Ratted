...
public final class ArgsClassGenerator implements IClassGenerator
{
    ...
    private byte[] generateClass(final String name, final String desc) {
        ...
        final ClassWriter writer = (ClassWriter)(visitor = (ClassVisitor)new ClassWriter(2));
        if (MixinEnvironment.getCurrentEnvironment().getOption(MixinEnvironment.Option.DEBUG_VERIFY)) {
            visitor = (ClassVisitor)new CheckClassAdapter((ClassVisitor)writer);
        }
        visitor.visit(50, 4129, ref, (String)null, ArgsClassGenerator.ARGS_REF, (String[])null);
    ...
    private void generateCtor(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        final MethodVisitor ctor = writer.visitMethod(2, "<init>", "([Ljava/lang/Object;)V", (String)null, (String[])null);
        ctor.visitCode();
    ...
    private void generateToString(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        final MethodVisitor toString = writer.visitMethod(1, "toString", "()Ljava/lang/String;", (String)null, (String[])null);
        toString.visitCode();
        toString.visitLdcInsn((Object)("Args" + getSignature(args)));
    ...
    private void generateFactory(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        ...
        final MethodVisitorEx of = new MethodVisitorEx(writer.visitMethod(9, "of", factoryDesc, (String)null, (String[])null));
        of.visitCode();
        ...
        for (final Type arg : args) {
            ...
            final byte b = argIndex;
            ++argIndex;
            methodVisitorEx.visitVarInsn(opcode, (int)b);
            box(of, arg);
            of.visitInsn(83);
        }
    ...
    private void generateGetters(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        ...
        for (final Type arg : args) {
            ...
            final MethodVisitorEx get = new MethodVisitorEx(writer.visitMethod(1, name, sig, (String)null, (String[])null));
            get.visitCode();
    ...
    private void generateIndexedSetter(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        final MethodVisitorEx set = new MethodVisitorEx(writer.visitMethod(1, "set", "(ILjava/lang/Object;)V", (String)null, (String[])null));
        set.visitCode();
    ...
    private void generateMultiSetter(final String ref, final String desc, final Type[] args, final ClassVisitor writer) {
        final MethodVisitorEx set = new MethodVisitorEx(writer.visitMethod(1, "setAll", "([Ljava/lang/Object;)V", (String)null, (String[])null));
        set.visitCode();
        ...
        set.visitInsn(88);
        set.visitConstant((byte)args.length);
        set.visitLdcInsn((Object)getSignature(args));
    ...
    private static void throwNPE(final MethodVisitorEx method, final String message) {
        ...
        method.visitInsn(89);
        method.visitLdcInsn((Object)message);
