...
public class WurstplusButtonBind extends WurstplusAbstractWidget
{
    ...
    public WurstplusButtonBind(final WurstplusFrame frame, final WurstplusModuleButton master, final String tag, final int update_postion) {
    ...
    public void render(final int master_y, final int separe, final int absolute_x, final int absolute_y) {
        ...
        if (this.waiting) {
            ...
            WurstplusDraw.draw_string("Bound to: [" + this.master.get_module().get_bind("string") + "]", this.x + 2, this.save_y, ns_r, ns_g, ns_b, ns_a);
        }
