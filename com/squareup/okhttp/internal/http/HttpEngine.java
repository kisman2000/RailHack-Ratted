...
public final class HttpEngine
{
    ...
    public HttpEngine(final OkHttpClient client, final Request request, final boolean bufferRequestBody, final boolean callerWritesRequestBody, final boolean forWebSocket, final StreamAllocation streamAllocation, final RetryableSink requestBodyOut, final Response priorResponse) {
        ...
        this.requestBodyOut = (Sink)requestBodyOut;
            ...
            if (this.callerWritesRequestBody && this.permitsRequestBody(this.networkRequest) && this.requestBodyOut == null) {
                ...
                if (this.bufferRequestBody) {
                    ...
                    if (contentLength != -1L) {
                        ...
                        this.requestBodyOut = (Sink)new RetryableSink((int)contentLength);
                    }
                    else {
                        this.requestBodyOut = (Sink)new RetryableSink();
                    }
                }
                else {
                    this.httpStream.writeRequestHeaders(this.networkRequest);
    ...
    private Response unzip(final Response response) throws IOException {
        ...
        final GzipSource responseBody = new GzipSource((Source)response.body().source());
    ...
    public Request followUpRequest() throws IOException {
        ...
        final Connection connection = (Connection)this.streamAllocation.connection();
    ...
    private static Address createAddress(final OkHttpClient client, final Request request) {
        ...
        return new Address(request.httpUrl().host(), request.httpUrl().port(), client.getDns(), client.getSocketFactory(), sslSocketFactory, hostnameVerifier, certificatePinner, client.getAuthenticator(), client.getProxy(), (List)client.getProtocols(), (List)client.getConnectionSpecs(), client.getProxySelector());
    }
    ...
    class NetworkInterceptorChain implements Interceptor.Chain
    {
        ...
        public Response proceed(final Request request) throws IOException {
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors().size()) {
                ...
                final Response interceptedResponse = interceptor.intercept((Interceptor.Chain)chain);
                if (chain.calls != 1) {
