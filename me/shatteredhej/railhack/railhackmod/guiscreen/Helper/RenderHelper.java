...
package me.shatteredhej.railhack.railhackmod.guiscreen.Helper;
...
public class RenderHelper
{
    ...
    public static void blurScreen() {
        GL11.glColor4f(0.33f, 0.33f, 0.33f, 0.9f);
        drawFilledRectangle(0.0f, 0.0f, (float)Minecraft.getMinecraft().displayWidth, (float)Minecraft.getMinecraft().displayHeight);
    }
