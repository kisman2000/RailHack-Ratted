...
public class PathFileComparator extends AbstractFileComparator implements Serializable
{
    ...
    static {
        ...
        PATH_REVERSE = (Comparator)new ReverseComparator(PathFileComparator.PATH_COMPARATOR);
        PATH_INSENSITIVE_COMPARATOR = (Comparator)new PathFileComparator(IOCase.INSENSITIVE);
        PATH_INSENSITIVE_REVERSE = (Comparator)new ReverseComparator(PathFileComparator.PATH_INSENSITIVE_COMPARATOR);
        PATH_SYSTEM_COMPARATOR = (Comparator)new PathFileComparator(IOCase.SYSTEM);
        PATH_SYSTEM_REVERSE = (Comparator)new ReverseComparator(PathFileComparator.PATH_SYSTEM_COMPARATOR);
    }
}
