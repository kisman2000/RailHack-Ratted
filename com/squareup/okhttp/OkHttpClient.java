...
import com.squareup.okhttp.internal.tls.*;
...
public class OkHttpClient implements Cloneable
{
    ...
    public OkHttpClient setProtocols(List<Protocol> protocols) {
        protocols = (List<Protocol>)Util.immutableList((List)protocols);
        ...
        this.protocols = (List<Protocol>)Util.immutableList((List)protocols);
        return this;
    }
    ...
    OkHttpClient copyWithDefaults() {
        ...
        if (result.hostnameVerifier == null) {
            result.hostnameVerifier = (HostnameVerifier)OkHostnameVerifier.INSTANCE;
        }
    ...
    static {
        DEFAULT_PROTOCOLS = Util.immutableList((Object[])new Protocol[] { Protocol.HTTP_2, Protocol.SPDY_3, Protocol.HTTP_1_1 });
